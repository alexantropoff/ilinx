...
- (void) setVolume: (NSUInteger) volume
{
  ...
  {
    _volume = volume;
      [self _sendCommand: [NSString stringWithFormat: @"LEVEL_SET VOL,%lu", (unsigned long)volume]];
  }
}
...
- (void) setBalance: (NSUInteger) balance
{
  ...
  {
    _balance = balance;
      [_pcomms send: [NSString stringWithFormat: @"LEVEL_SET BALANCE,%lu", (unsigned long)balance] to: _serviceName];
  }
}
...
- (void) setBass: (NSUInteger) bass
{
  ...
  {
    _bass = bass;
      [_pcomms send: [NSString stringWithFormat: @"LEVEL_SET BASS,%lu", (unsigned long)bass] to: _serviceName];
  }
}
...
- (void) setTreble: (NSUInteger) treble
{
  ...
  {
    _treble = treble;
      [_pcomms send: [NSString stringWithFormat: @"LEVEL_SET TREB,%lu", (unsigned long)treble] to: _serviceName];
  }
}
...
- (void) setBand1: (NSUInteger) band1
{
  ...
  {
    _band1 = band1;
      [_pcomms send: [NSString stringWithFormat: @"LEVEL_SET band_1,%lu", (unsigned long)band1] to: _serviceName];
  }
}
...
- (void) setBand2: (NSUInteger) band2
{
  ...
  {
    _band2 = band2;
      [_pcomms send: [NSString stringWithFormat: @"LEVEL_SET band_2,%lu", (unsigned long)band2] to: _serviceName];
  }
}
...
- (void) setBand3: (NSUInteger) band3
{
  ...
  {
    _band3 = band3;
      [_pcomms send: [NSString stringWithFormat: @"LEVEL_SET band_3,%lu", (unsigned long)band3] to: _serviceName];
  }
}
...
- (void) setBand4: (NSUInteger) band4
{
  ...
  {
    _band4 = band4;
      [_pcomms send: [NSString stringWithFormat: @"LEVEL_SET band_4,%lu", (unsigned long)band4] to: _serviceName];
  }
}
...
- (void) setBand5: (NSUInteger) band5
{
  ...
  {
    _band5 = band5;
      [_pcomms send: [NSString stringWithFormat: @"LEVEL_SET band_5,%lu", (unsigned long)band5] to: _serviceName];
  }
}
...
- (void) setLoud: (NSInteger) loud
{
  ...
  {
    _loud = loud;
      [_pcomms send: [NSString stringWithFormat: @"LOUDNESS %ld", (long)loud] to: _serviceName];
  }
}
  ...
  if (_audioSessionActive)
  {
    if (_noFeedback)
      [_netStreamsComms send: @"LEVEL_SET VOL DEFAULT" to: _audioSessionName];
        ...
        [_netStreamsComms send: [NSString stringWithFormat: @"LEVEL_SET VOL %lu", (unsigned long)_volume] to: _audioSessionName];
  }
}
