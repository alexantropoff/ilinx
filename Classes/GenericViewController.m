...
- (void) loadScrollViewForPage: (NSUInteger) page
{
  if (page < _pager.numberOfPages)
  {
    ...
    GenericPageViewController *controller = [_pageControllers objectAtIndex: page];
    
    if ((NSNull *) controller == [NSNull null])
    {
      controller = [[GenericPageViewController alloc]
                    initWithService: _genericService offset: page * BUTTONS_PER_PAGE count: BUTTONS_PER_PAGE];
