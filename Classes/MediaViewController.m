...
- (void) loadView
{
  ...
  _artist.lineBreakMode = NSLineBreakByTruncatingMiddle;
  ...
  _song.lineBreakMode = NSLineBreakByTruncatingMiddle;
  ...
  _album.lineBreakMode = NSLineBreakByTruncatingMiddle;
  ...
  _flipBase = [[UIView alloc] initWithFrame: 
               CGRectMake( 0, 20, contentBounds.size.width, contentBounds.size.height )];
  ...
  if ((((NLSourceMediaServer *) _source).capabilities & SOURCE_MEDIA_SERVER_CAPABILITY_REPEAT) != 0)
  {
    button = [[UIBarButtonItem alloc]
              initWithImage: [UIImage imageNamed: @"Shim.png"] style: UIBarButtonItemStylePlain
  ...
  _timeSoFar.textAlignment = NSTextAlignmentRight;
  ...
  _timeRemaining.textAlignment = NSTextAlignmentLeft;
  ...
  _nextSong.textAlignment = NSTextAlignmentLeft;
  _nextSong.lineBreakMode = NSLineBreakByTruncatingMiddle;
  ...
  _detailView = [[UITableView alloc] initWithFrame: _flipBase.frame];
