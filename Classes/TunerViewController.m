...
- (void) loadView
{
  ...
  _titleLine1.lineBreakMode = NSLineBreakByTruncatingMiddle;
  _titleLine1.textAlignment = NSTextAlignmentCenter;
  ...
  _titleLine2.lineBreakMode = NSLineBreakByTruncatingMiddle;
  _titleLine2.textAlignment = NSTextAlignmentCenter;
  ...
  _titleLine3.lineBreakMode = NSLineBreakByTruncatingMiddle;
  _titleLine3.textAlignment = NSTextAlignmentCenter;
  ...
  _titleLines12.lineBreakMode = NSLineBreakByTruncatingMiddle;
  _titleLines12.textAlignment = NSTextAlignmentCenter;
  ...
  _titleLines123.lineBreakMode = NSLineBreakByTruncatingMiddle;
  _titleLines123.textAlignment = NSTextAlignmentCenter;
  ...
  _noLogoCaption.textAlignment = NSTextAlignmentCenter;
  ...
  _bandIndicator.textAlignment = NSTextAlignmentCenter;
  ...
  _tuningIndicator.textAlignment = NSTextAlignmentCenter;
  ...
  _stereoIndicator.textAlignment = NSTextAlignmentCenter;
...
- (void) handleRadioText: (NSString *) radioText
{
  ...
  if ([radioText length] > 0)
  {
    ...
    CGSize actualTextArea = [newRadioText sizeWithFont: _radioText.font constrainedToSize: _radioText.frame.size lineBreakMode: NSLineBreakByWordWrapping];
    ...
    else if (numberOfLines > visibleLines)
    {
      ...
      do
      {
        ...
        actualTextArea = [candidate sizeWithFont: _radioText.font constrainedToSize: _radioText.frame.size lineBreakMode: NSLineBreakByWordWrapping];
