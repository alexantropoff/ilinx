                      ...
                      table: (UITableView *) table
{
  if (self = [super initDefaultWithFrame: frame reuseIdentifier: reuseIdentifier table: table])
  {
    ...
    _nameLabel = [[UILabel alloc] initWithFrame: CGRectMake( MARGIN, 12, NAME_WIDTH, 20)];
    ...
    _valueLabel = [[UILabel alloc] initWithFrame: CGRectMake( NAME_WIDTH + (MARGIN * 2), 12, dataWidth, 20 )];
    ...
    _valueEdit = [[UITextField alloc] initWithFrame: CGRectMake( NAME_WIDTH + (MARGIN * 2), 12, dataWidth, 20 )];
    ...
    if (_valueEdit.frame.size.height < table.rowHeight)
      ...
      _valueEdit.frame = CGRectMake( NAME_WIDTH + (MARGIN * 2), 12, dataWidth, _valueEdit.frame.size.height );
    _valueEdit.backgroundColor = [UIColor clearColor];
    _valueEdit.textAlignment = NSTextAlignmentRight;
