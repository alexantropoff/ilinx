                ...
                title: (NSString *) title2 target: (id) target2 selector: (SEL) selector2
{
  ...
  [toolbar setFrame:
   CGRectMake( CGRectGetMinX( mainViewBounds ), 55,
  ...
  if (title1 == nil)
    ...
    item1 = [[UIBarButtonItem alloc] initWithTitle: title1 style: UIBarButtonItemStylePlain
                                            target: target1 action: selector1];
  if (title2 == nil)
    item2 = nil;
  else
    item2 = [[UIBarButtonItem alloc] initWithTitle: title2 style: UIBarButtonItemStylePlain
           ...
           withListData: (id<ListDataSource>) dataSource headerView: (UIView *) view
{
    ...
    [currentNavigationController presentViewController:nav animated:YES completion:nil];
    [controller release];
    [nav release];
}
